...
struct RepositoriesCodable: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        owner = try values.decodeIfPresent(OwnerCodable.self, forKey: .owner)
        ...
        license = try values.decodeIfPresent(LicenseCodable.self, forKey: .license)
